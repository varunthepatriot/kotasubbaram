...
<div class="container-fluid" style="padding-left: 0px; padding-right: 0px">
  <div class="container-fluid" style="padding-left: 0px; padding-right: 0px">
    ...
    <div class="container-fluid" style="padding-left: 0px; padding-right: 0px; background-color: #f8abac;">
      <div class="container">
        <ul class="breadcrumb">
    ...
    <div class="container-fluid" style="padding-left: 0px; padding-right: 0px; margin-bottom: 30px; background-color: #f8abac">
      <div class="container">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px; line-height: 28px;">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="font-size: 27px;">
            <img alt="" src="img/yourpage.png" style="width: 70px; margin-right: 20px;"/>
            YOUR PAGE
          </div>
                    ...
                    <div class="row">
                      <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <form action="forms/sendmail.php" method="post" data-form-title="CONTACT US">
                          ...
                          <div>
                            <button name="formId" value="2" type="submit" class="btn btn-lg btn-danger">CONTACT US</button>
                          </div>
                        </form>
                      </div>
                    </div>
