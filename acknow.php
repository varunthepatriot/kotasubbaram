...
<div class="container-fluid" style="padding-left: 0px; padding-right: 0px">
  <div class="container-fluid" style="padding-left: 0px; padding-right: 0px;background-color:#F1BAC7">
    <div class="headerbg">
    ...
    <div class="container-fluid" style="padding-left: 0px; padding-right: 0px; background-color: #f1bac7;">
      <div class="container">
        <ul class="breadcrumb">
          ...
          <li><a href="miscellany.php">Miscellany</a></li>
    ...
    <div class="container-fluid" style="padding-left: 0px; padding-right: 0px; margin-bottom: 30px;">
      <div class="container">
        <div class="container">
          <div class="col-12">
            <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12" style="margin-top: 30px; line-height: 28px;">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="font-size: 25px;">
                <img alt="" src="img/ackn.png" style="width: 70px; margin-right: 20px;"/>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  <ul style="padding-left: 20px;">
                    ...
                    <li style="font-size: 16px">
                      Any apparent absence of relevant material in this WebHome is to be deemed only as inadvertent and
                      not intentional.
                      <hr/>
                    </li>
                    <li style="font-size: 16px">
